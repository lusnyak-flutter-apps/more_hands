...
abstract class _$$OnboardingLoadedStateImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({int page, List<OnboardingViewModel> data});
}
...
class _$OnboardingLoadedStateImpl implements _OnboardingLoadedState {
  const _$OnboardingLoadedStateImpl(
      {this.page = 0, required final List<OnboardingViewModel> data})
      : _data = data;

  @override
  @JsonKey()
  final int page;
  final List<OnboardingViewModel> _data;
  @override
  List<OnboardingViewModel> get data {
  ...
  @override
  String toString() {
    return 'OnboardingState.loaded(page: $page, data: $data)';
  }
...
abstract class _OnboardingLoadedState implements OnboardingState {
  const factory _OnboardingLoadedState(
          {final int page, required final List<OnboardingViewModel> data}) =
