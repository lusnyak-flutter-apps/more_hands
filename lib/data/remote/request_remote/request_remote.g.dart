...
class _RequestRemoteApi implements RequestRemoteApi {
  _RequestRemoteApi(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<List<RequestModel>?> getBySender({
    ...
    try {
      _value = _result.data
          ?.map(
            (dynamic i) => RequestModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<RequestsCountModel?> getUnseenCountBySender({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RequestsCountModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/request/getBySenderCnt',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late RequestsCountModel? _value;
    try {
      _value = _result.data == null
          ? null
          : RequestsCountModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
