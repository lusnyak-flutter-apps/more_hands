...
class _SubscriptionRemoteApi implements SubscriptionRemoteApi {
  ...
  @override
  Future<List<ServerSubscriptionDTO>> getAvailableSubscriptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ServerSubscriptionDTO>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/transactionTypeRef/canBuy',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late List<ServerSubscriptionDTO> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ServerSubscriptionDTO.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
