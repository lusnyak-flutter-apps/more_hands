...
class _$SubscriptionModelImpl implements _SubscriptionModel {
  ...
  @override
  String toString() {
    return 'SubscriptionModel(id: $id, title: $title, description: $description, price: $price, durationInDays: $durationInDays, currencySymbol: $currencySymbol, koef: $koef, orderNum: $orderNum, canBuy: $canBuy)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, price,
      durationInDays, currencySymbol, koef, orderNum, canBuy);
